...
from restoran import * #restoran.py içerisindeki tüm fonksiyonlar dahil edildi.
...
def restoran_icerik(self,restoran_ad):
        ...
        for i in range(4): 
            for j in range(3):  # 3 sütun
                ...
                if i == 0 and j == 0:
                    restoran_satis_toplami = rst_toplam_satis(restoran_ad)  
                ...
                if i == 0 and j == 1:
                    restoran_teslimat_suresi = rst_ortalama_teslimat_suresi(restoran_ad)  
                    strcolor = FG_TEXT
                ...
                if i == 0 and j == 2:
                    restoran_gecikme = rst_gecikme_orani(restoran_ad)  
                    strcolor = FG_TEXT
                ...
                #2.Satır 1.Sütun (1,0) - En Çok Satış Yapan Şube
                if i == 1 and j == 0:
                    cok_satan_sube = rst_en_cok_satan_sube(restoran_ad)  
                    label = ctk.CTkLabel(cell, 
                ...
                #2.Satır 2.Sütun (1,1) - Gecikme Oranı En Düşük Şube
                if i == 1 and j == 1:
                    en_dusuk_gecikme_orani_sube = rst_gecikme_orani_en_dusuk_sube(restoran_ad)  
                    strcolor = FG_TEXT
                ...
                #2.Satır 3.Sütun (1,2) - Gecikme Oranı En Yüksek Şube
                if i == 1 and j == 2:
                    en_yuksek_gecikme_orani_sube = rst_gecikme_orani_en_yuksek_sube(restoran_ad)  
                    strcolor = FG_TEXT
                ...
                #3.Satır 1.Sütun (2,0) - En Az Satış Yapan Şube
                if i == 2 and j == 0:
                    az_satan_sube = rst_en_az_satan_sube(restoran_ad) 
                    label = ctk.CTkLabel(cell, 
                ...
                #3.Satır 2.Sütun (2,1) - En Çok Tercih Edilen Ödeme Yöntemi
                if i == 2 and j == 1:
                    en_cok_tercih_odeme_methodu = rst_odeme_yontemi(restoran_ad)  
                    label = ctk.CTkLabel(cell, 
                ...
                #3.Satır 3.Sütun (2,2) - En Çok Tercih Edilen Sipariş Yöntemi
                if i == 2 and j == 2:
                    en_cok_tercih_siparis_methodu = rst_siparis_yontemi(restoran_ad)  
                    label = ctk.CTkLabel(cell, 
                                       text=f"En Çok Tercih Edilen Sipariş Yöntemi:\n\n{en_cok_tercih_siparis_methodu['Method']}\n{en_cok_tercih_siparis_methodu['Oran']}%", 
                                       font=ctk.CTkFont(size=14, weight="bold"))
                    label.pack(expand=True)

                #4. Satır 1.Sütun (3,0) - Saatlik Yoğunluk Grafiği
                if i == 3 and j ==0:
                ...
                #4.Satır 2.Sütun (3,1) - Aylık Satış Grafiği
                if i == 3 and j == 1:
                ...
                #4.Satır 3.Sütun (3,2) - Pizza Tipi Grafiği                   
                if i == 3 and j == 2: 
